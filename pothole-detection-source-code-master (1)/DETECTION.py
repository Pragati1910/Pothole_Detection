...
im = cv2.imread("C:/Users/Piyush/Downloads/pothole-detection-source-code-master (1)/index4.jpg")
...
img = cv2.imread("C:/Users/Piyush/Downloads/pothole-detection-source-code-master (1)/index4.jpg",0)
...
plt.show()
pygame.init()
pygame.mixer.music.load("C:/Users/Piyush/Downloads/pothole-detection-source-code-master (1)/buzz.mp3")
